      ...
      <section className="bg-neutralWhite-100 dark:bg-neutral-900">
        <div className="container py-16 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
          ...
          <div className="flex-1 md:max-w-[400px] flex gap-4">
            <input
              className="flex-1 bg-transparent outline-none border border-neutral-100 dark:border-neutral-700 text-neutral-800 dark:text-neutral-100 placeholder-neutral-500 dark:placeholder-neutral-400 py-2 px-4"
              placeholder={subscribeData.inputPlaceholder}
              type="text"
            />
            <button className="bg-neutral-900 dark:bg-neutral-100 rounded px-6 py-2 text-neutralWhite-900 dark:text-neutral-900 text-sm font-medium">
        ...
        <div className="pl-4 md:pl-0 grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 py-8 gap-8 ">
          ...
          <div className="flex flex-col items-start mr-8">
            <div className="flex gap-4 items-center">
              <div className="py-[9px] px-[14px] border border-neutral-100 dark:border-neutral-700 rounded-md">
                <img
            ...
            <p className="mt-3 mb-8 text-neutral-500 dark:text-neutral-400 text-sm">
          ...
          {footerData.Links.map((link, index) => {
            return (
              <div key={index}>
                <p className="text-neutral-300 dark:text-neutral-500  text-sm font-medium mb-10">
                  {link.title}
                </p>
                  ...
                  {link.links.map((item, index) => {
                    return (
                      <Link
                        to={item.href}
                        key={index}
                        className="text-neutral-500 dark:text-neutral-400 text-sm font-medium"
                      >
                        {item.name}
                      </Link>
                    );
